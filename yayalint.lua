...
local ForCondition  = Lpeg.Ct(Lpeg.Cg(Lpeg.Ct(Expression), "init") * Space ^ 0 * ForCondSep * Space ^ 0 * Lpeg.Cg(Lpeg.Ct(Expression), "condition") * Space ^ 0 * ForCondSep * Space ^ 0 * Lpeg.Cg(Lpeg.Ct(Expression), "next"))
